...
public class Janela extends JFrame {
	...
	public Janela() {
		...
		scrollPane.setBounds(15, 225, 440, 201);
		...
		txtNome.setBounds(10, 36, 207, 20);
		contentPane.add(txtNome);
		txtNome.setColumns(10);

		lblNewLabel = new JLabel("CPF");
		lblNewLabel.setBounds(15, 139, 46, 14);
		contentPane.add(lblNewLabel);

		txtCPF = new JTextField();
		txtCPF.setBounds(15, 160, 202, 20);
		...
		btnNewButton.setBounds(45, 191, 113, 30);
		...
		btnNewButton_1.setBounds(305, 191, 107, 30);
		...
		btnNewButton_2.setBounds(179, 191, 107, 30);
		contentPane.add(btnNewButton_2);

		txtTelefone = new JTextField();
		txtTelefone.setBounds(15, 98, 202, 20);
		contentPane.add(txtTelefone);
		txtTelefone.setColumns(10);

		txtIdade = new JTextField();
		txtIdade.setBounds(253, 160, 202, 20);
		contentPane.add(txtIdade);
		txtIdade.setColumns(10);

		txtAltura = new JTextField();
		txtAltura.setBounds(253, 36, 202, 20);
		contentPane.add(txtAltura);
		txtAltura.setColumns(10);

		txtPeso = new JTextField();
		txtPeso.setBounds(253, 98, 202, 20);
		...
		lblNewLabel_2.setBounds(253, 139, 46, 14);
		contentPane.add(lblNewLabel_2);

		JLabel lblNewLabel_3 = new JLabel("Peso");
		lblNewLabel_3.setBounds(253, 73, 46, 14);
		contentPane.add(lblNewLabel_3);

		JLabel lblNewLabel_4 = new JLabel("Altura");
		lblNewLabel_4.setBounds(253, 11, 46, 14);
